...
import { View, Text, ScrollView, StatusBar, StyleSheet, TouchableOpacity, Switch } from "react-native";
          ...
          <Link href="/(auth)/profile" asChild>
            <TouchableOpacity style={styles.btn}>
              ...
              <View>
                ...
                <Text style={styles.btnTextSmall}>Change email, number</Text>
              </View>
              <MaterialIcons name="arrow-forward-ios" size={20} color="black" style={{marginLeft: "auto"}} />
            </TouchableOpacity>
          </Link>
          <Link href="/(auth)/profile" asChild>
            <TouchableOpacity style={styles.btn}>
